<template>
  <div class="welcome-container" :style="{ backgroundImage: `url(${welcomeBgImage})` }">
    ...
    <div v-else class="welcome-detail">
      <div class="welcome-detail-title">
        ...
        <div class="welcome-detail-title-text">{{ avtivePage === 'localDeploy' ? '后端本地部署' : '后端在线服务' }}</div>
      </div>
...
.welcome-container {
  ...
  font-size: 24px;
  color: #333;
  background-image: url("../../src/assets/images/welcome_bg.webp");
