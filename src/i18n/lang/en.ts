export default {
  ...
  flow: {
    ...
    add_first_param: 'Add first parameter',
    duplicate_param_key: 'Parameter name cannot be duplicate',
    ...
    invalid_param_name: 'Invalid parameter name format',
  },
  pagination: {
    prev: 'Previous',
    next: 'Next',
