...
const reportLabel = ['pornographic_content','account_violation','politically_sensitive_content','violence_or_terrorism','defamation_or_rumor_spreading','insult_to_heroes_or_martyrs','spam','ethnic_or_religious_incitement','disturbing_content','abuse_or_harassment','gambling_or_fraud','consumer_manipulation','harm_to_minors','illegal_or_prohibited_items','other_violations'];
const reportList=<
  {
    label: string;
    isChecked: boolean;
...
<template>
    <div class="against-popover">
        ...
        <div class="error-input">
            <textarea class="error-input__desc" v-model="descText" :placeholder="$t('feedback.enter_a_description_for_your_report')" />
        </div>
