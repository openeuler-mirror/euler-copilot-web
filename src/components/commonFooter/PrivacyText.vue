<template>
  <div class="textBody">
    <div class="text-header">openEuler Copilot System 隐私政策</div>
    <p>
    ...
    <strong>2.2 我们使用二种类型的Cookie</strong>
    <ul>
      <li>严格必要的Cookie: 当您使用网站时，Cookie将确保您对该网站的访问尽可能顺利、安全;</li>
      <li>
    ...
    <h2>6. 如何访问或控制您的个人信息</h2>
    <ul>
      <li>访问我们持有的您的个人信息并获得副本的权利;</li>
      <li>要求我们更新或更正您的个人信息的权利;</li>
      <li>要求我们删除您的个人信息的权利；</li>
      <li>反对我们对您的个人信息进行处理的权利；</li>
      <li>限制我们对您的个人信息进行处理的权利；</li>
      <li>向有权的个人信息保护部门提起投诉、举报的权利。</li>
    </ul>
