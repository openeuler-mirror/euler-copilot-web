...
本协议约束您（使用者）对 [EulerCopilot](https://eulercopilot.gitee.com) 网站等相关服务（以下简称“本服务”或“EulerCopilot”）的使用。
...
EulerCopilot（内测版）旨在让内测用户提前体验 openEuler 原生开发平台的智能化能力，帮助发现和修复版本质量、可用性及易用性问题，共同将版本做得更加完善。如果您发现任何问题（包括软件设计、软件功能、不合适的问答对等），欢迎您反馈您的宝贵意见！
...
**1.1 用户** ：指通过 [EulerCopilot](https://eulercopilot.gitee.com) 网站使用 EulerCopilot 服务的自然人。本协议中可称为“使用者”或“您”。
